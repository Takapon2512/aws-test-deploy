...
//足し算
exports.calculateRouter.post("/plus", (req, res) => {
    const values = req.body;
    try {
        const numResult = Number(values.value1) + Number(values.value2);
...
//引き算
exports.calculateRouter.post("/minus", (req, res) => {
    const values = req.body;
    try {
        const numResult = Number(values.value1) - Number(values.value2);
        const result = String(numResult);
...
//かけ算
exports.calculateRouter.post("/multiplication", (req, res) => {
    const values = req.body;
    try {
        const numResult = Number(values.value1) * Number(values.value2);
        const result = String(numResult);
...
//割り算
exports.calculateRouter.post("/division", (req, res) => {
    const values = req.body;
    try {
        const numResult = Math.floor((Number(values.value1) / Number(values.value2)) * 100) / 100;
        const result = String(numResult);
        return res.status(200).json(result);
    }
    catch (err) {
...
exports.calculateRouter.get("/test", (req, res) => {
    try {
...
const cors_1 = __importDefault(__nccwpck_require__(3873));
//routers
const calculate_1 = __nccwpck_require__(6791);
const app = (0, express_1.default)();
const PORT = 8080;
app.use((0, cors_1.default)());
app.use(express_1.default.json());
app.use("/api/v1", calculate_1.calculateRouter);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(3431);
